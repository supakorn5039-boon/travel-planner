...
export default function Register(): React.ReactElement {
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            showSuccessToast('ลงทะเบียนสําเร็จ');
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-green-300 via-yellow-300 to-red-300">
            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 rounded-3xl shadow-2xl overflow-hidden">
                <div className="relative hidden md:flex items-center justify-center p-8 bg-cover bg-center fade-in-bg">
                    <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center p-4 text-white text-center">
                        <h1 className="text-4xl font-extrabold mb-4 drop-shadow-lg">Join Us Today!</h1>
                        <p className="text-lg font-medium max-w-sm drop-shadow-md">Create your account to explore amazing travel experiences.</p>
                    </div>
                </div>
                ...
                <div className="relative w-full bg-white p-8 space-y-8 md:p-12">
                    <div className="absolute top-2 left-1/2 -translate-x-1/2 bg-white p-4 rounded-full shadow-xl">
                        <div className="absolute inset-0 rounded-full border-4 border-t-red-500 border-r-yellow-500 border-b-green-500 border-l-blue-500 animate-spin" />
                        <IconTicket />
                    </div>

                    <h2 className="pt-8 text-3xl font-extrabold text-center text-gray-800">Create an Account</h2>
                    <p className="text-center text-gray-600 -mt-2">Join to plan your next adventure!</p>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <ButtonCustom
                            ...
                            className="w-full bg-gradient-to-r from-green-500 to-yellow-600 hover:from-green-600 hover:to-yellow-700 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                        />
                    </form>
